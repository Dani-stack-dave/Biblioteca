...
public class Biblioteca extends JFrame implements ActionListener {
    ...
    public Biblioteca() {
        ...
        //Panelde formulario para Agregar Libros
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("Agregar")) {
            ...
            if (!titulo.isEmpty() && !autor.isEmpty()) {
                ...
                txtAreaResultado.setText("Por favor, introduzca el titulo y el autor del libro.");
            ...
            if (!terminoBusqueda.isEmpty()) {
                ...
                txtAreaResultado.setText("Por favor introduzca un terminode busqueda");
            }
            txtTitulo.setText("");
            txtAutor.setText("");
    ...
    public List<String> buscarLibro(String terminoBusqueda, String tipoBusqueda) {
        ...
        for (Libro libro : libros) {
            if (tipoBusqueda.equalsIgnoreCase("titulo")) {
                if (libro.getTitulo().equalsIgnoreCase(tipoBusqueda)) {
                    resultados.add(libro.toString());
                }
            } else if (tipoBusqueda.equalsIgnoreCase("autor")) {
                if (libro.getAutor().equalsIgnoreCase(tipoBusqueda)) {
                    resultados.add(libro.toString());
                }
            }
